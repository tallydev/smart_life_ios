...
class ITPart3ViewController: UIViewController {
    ...
    func sure(){
        subscribe(self, type: "ITFW", count: "", orderBtn: orderBtn)
    ...
    override func viewDidLoad() {
        ...
        orderBtn.setTitle("我要报名", forState: .Normal)
